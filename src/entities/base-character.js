...
BaseCharacter.prototype.getDisplayName = function() {
    return this.name;
};

BaseCharacter.prototype.getDescription = function() {
    return this.description;
};

BaseCharacter.prototype.getStats = function() {
    return {
        id: this.id,
        name: this.name,
